...
$(X\cap Y)^C = X^C\cup Y^C$, $(X\cup Y)^C = X^C\cap Y^C$, $X-Y = X\cap Y^C$, $X\subseteq Y \rightarrow Y^C \subseteq X^C$, $X\subseteq Y \rightarrow X\cup(Y-X)=Y$, $X-Y \subseteq X\cup Y$