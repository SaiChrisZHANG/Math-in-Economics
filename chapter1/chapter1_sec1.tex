...
Apart from union, intersection, complement and relative difference (subtract), we can also take the \textbf{product} of two set:
\begin{definition}
    The \textbf{product} of two sets $X$ and $Y$ is the set of \textbf{ordered} pairs $X\times Y = \{(x,y):x\in X, y\in Y\}$
\end{definition}