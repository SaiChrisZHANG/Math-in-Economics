...
\begin{definition}\label{def_collect_subset}
    \begin{enumerate}
        ...
        i.e., $\mathcal{P}(X)\{A:A\subseteq X \}$\footnote{Fact: or any set $X$ with a finite number $n$ of elements, its power set $\mathcal{P}(X)$ has $2^n$ elements, including one $\varnothing$. This can be proved as: $\binom{n}{0}+\binom{n}{1}+\binom{n}{2}+\cdots+\binom{n}{n}=(x+y)^n \mid_{x=1,y=1}=2^n$}
    \end{enumerate}
\end{definition}
